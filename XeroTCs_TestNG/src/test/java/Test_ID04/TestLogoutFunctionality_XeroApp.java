...
public class TestLogoutFunctionality_XeroApp{
...
@Test
public TestLogoutFunctionality_XeroApp() throws Exception

{

logger = reports.startTest("TestLogoutFunctionality_XeroApp");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\XERO APP DOCS\\TestData XL Sheets","TestLogoutFunctionality_XeroApp.xls","TestLogoutFunctionality_XeroApp");
...
System.out.println("You are in Dashboard page");
	...
	WebElement UserDropdownMenu = driver.findElement(By.xpath("//abbr[@class='xrh-avatar xrh-avatar-color-4']"));
	 ...
	 WebElement LogoutSublink = UserDropdownMenu.findElement(By.linkText("Log out"));
	 Thread.sleep(1000);
	 LogoutSublink.click();
