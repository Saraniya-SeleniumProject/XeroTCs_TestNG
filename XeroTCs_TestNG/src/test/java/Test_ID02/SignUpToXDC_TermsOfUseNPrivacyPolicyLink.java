...
public class SignUpToXDC_TermsOfUseNPrivacyPolicyLink {
...
@Test
public  SignUpToXDC_TermsOfUseNPrivacyPolicyLink() throws Exception

{

logger = reports.startTest("SignUpToXDC_TermsOfUseNPrivacyPolicyLink");
