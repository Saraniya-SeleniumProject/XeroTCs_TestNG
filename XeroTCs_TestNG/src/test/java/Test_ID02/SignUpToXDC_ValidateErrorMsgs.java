...
public class SignUpToXDC_ValidateErrorMsgs {
...
@Test
public  SignUpToXDC_ValidateErrorMsgs() throws Exception

{

logger = reports.startTest("SignUpToXDC_ValidateErrorMsgs");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\XERO APP DOCS\\TestData XL Sheets","SignUpToXDC_ValidateErrorMsgs.xls","SignUpToXDC_ValidateErrorMsgs");
...
{
     //Click GetStartedButton without entering text in any of the fields
	 WebElement GetStartedButton = driver.findElement(By.xpath("//span[@class='g-recaptcha-submit']"));
    //Check GetStartedButon is disabled 
	...
	//FirstName textbox WebElement
     ...
     //EmailAddress textbox WebElement - wrong format
     		WebElement EmailAddress = driver.findElement(By.xpath("//input[@name='EmailAddress']"));
     		String EmailAddress_data = data[1][2];
    	...
    	//Country Select Dropdown 
     	 ...
     	 WebElement ActualErrormessage = driver.findElement(By.xpath("//span[@id='signup-form-error-message-1']"));
     String ExpectedErrormessage ="Email address is invalid";
     if(ActualErrormessage.getText() == ExpectedErrormessage )
     {
     	...
     	WebElement TermsNPolicy_ChkBox1 = driver.findElement(By.xpath("//input[@name='TermsAccepted']"));
		 if (!TermsNPolicy_ChkBox1.isSelected())
		 {
			
		 WebElement GetStartedButton3 = driver.findElement(By.xpath("//span[@class='g-recaptcha-submit']"));
         GetStartedButton1.click();
         if (!GetStartedButton3.isEnabled())
         {
        	 WebElement SignUpFormPage = driver.findElement(By.name("signupForm"));
        	 if (SignUpFormPage.isDisplayed())
        	 {
        		 System.out.println ("Sign Up Not Successful, Check the term and Policy checkbox");
